    ...
    <div className="px-4 py-3">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 border border-foreground rounded-lg px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-indigo-500"
          placeholder="Nama chat"
        />
        <button
          onClick={handleSubmit}
          className="text-xs bg-primary hover:bg-indigo-700 text-white rounded-lg px-3 py-1"
        >
          Simpan
        </button>
      </div>
